...
export default function Sidebar() {
  return (
    <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]" style={{background:'#0a0a0a'}}>
      <div className="hidden border-r bg-muted/40 md:block" style={{background:'#0a0a0a'}}>
